<aside class="main-sidebar sidebar-light-purple elevation-4">
  ...
  <a href="admin_dashboard.html" class="brand-link">
    <img src="{{asset('images/AdminLTELogo.png')}}" alt="logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light"> &nbsp;  {{session('name')}}</span>
  </a>
  <!-- Sidebar -->
  <div class="sidebar">
